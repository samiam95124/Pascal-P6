...
instab: inspar = array
  ...
  record 'dif       ', 1, false, false end,
  record 'int       ', 1, false, false end,
  record 'uni       ', 1, false, false end,
