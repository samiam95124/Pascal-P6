...
sfptab: spfpar = array
   ...
   record 'rln       ', false, 1, false end,
   record 'new       ', false, 2, false end,
   record 'wln       ', false, 1, false end,
   record 'wrs       ', false, 4, false end,
   record 'eln       ', true,  1, false end,
   record 'wri       ', false, 3, false end,
   record 'wrr       ', false, 3, false end,
   record 'wrc       ', false, 3, false end,
   record 'rdi       ', false, 2, false end,
   record 'rdr       ', false, 2, false end,
   record 'rdc       ', false, 2, false end,
   ...
   record 'wrb       ', false, 3, false end,
   record 'wrf       ', false, 4, false end,
   record 'dsp       ', false, 2, false end,
   record 'wbf       ', false, 3, false end,
   record 'wbi       ', false, 2, false end,
   record 'wbr       ', false, 2, false end,
   record 'wbc       ', false, 2, false end,
   record 'wbb       ', false, 2, false end,
   record 'rbf       ', false, 3, false end,   
   record 'rsb       ', false, 1, false end,
   record 'rwb       ', false, 1, false end,   
   record 'gbf       ', false, 2, false end,
   record 'pbf       ', false, 2, false end,   
   record 'rib       ', false, 4, false end,
   record 'rcb       ', false, 4, false end,   
   ...
   record 'wrih      ', false, 3, false end,
   record 'wrio      ', false, 3, false end,
   record 'wrib      ', false, 3, false end,
   record 'wrsp      ', false, 3, false end,
   record 'wiz       ', false, 3, false end,
   record 'wizh      ', false, 3, false end,
   record 'wizo      ', false, 3, false end,
   record 'wizb      ', false, 3, false end,
   record 'rds       ', false, 3, false end,
   record 'ribf      ', false, 5, false end,
   record 'rdif      ', false, 3, false end,
   record 'rdrf      ', false, 3, false end,
   record 'rcbf      ', false, 5, false end,
   record 'rdcf      ', false, 3, false end,
   record 'rdsf      ', false, 4, false end,
   record 'rdsp      ', false, 3, false end,
   record 'aeft      ', false, 3, false end,
   record 'aefb      ', false, 3, false end,
   record 'rdie      ', false, 3, false end,
   record 'rdre      ', false, 3, false end,
   record 'rdx       ', false, 2, false end,
   record 'rdxf      ', false, 3, false end,
   record 'rxb       ', false, 4, false end,
   record 'rxbf      ', false, 5, false end,
   record 'rdsc      ', false, 3, false end,
   record 'rdih      ', false, 2, false end,
   record 'rdio      ', false, 2, false end,    
   record 'rdib      ', false, 2, false end,
   record 'rifh      ', false, 3, false end,
   record 'rifo      ', false, 3, false end,
   record 'rifb      ', false, 3, false end,
   record 'ribh      ', false, 4, false end,
   record 'ribo      ', false, 4, false end,
   record 'ribb      ', false, 4, false end,
   record 'rbfh      ', false, 5, false end,
   record 'rbfo      ', false, 5, false end,
   record 'rbfb      ', false, 5, false end,
   record 'rdxh      ', false, 2, false end,
   record 'rdxo      ', false, 2, false end,
   record 'rdxb      ', false, 2, false end,
   record 'rxfh      ', false, 3, false end,
   record 'rxfo      ', false, 3, false end,
   record 'rxfb      ', false, 3, false end,
   record 'rxbh      ', false, 4, false end,
   record 'rxbo      ', false, 4, false end,
   record 'rxbb      ', false, 4, false end,
   record 'rbxh      ', false, 5, false end,
   record 'rbxo      ', false, 5, false end,
   record 'rbxb      ', false, 5, false end,
