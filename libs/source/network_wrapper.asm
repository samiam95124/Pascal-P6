# Generated network trampolines. Do not edit by hand.
    .text
...
network.addrnet$p_vc_x$0$9223372036854775807$i:
    jmp     wrapper_addrnet
...
network.certlistmsg$p_i_i_pr$name$0$pvc$data$8$p12$critical$16$b$fork$20$p2$next$28$p2$:
    jmp     wrapper_certlistmsg

network.certlistnet$p_fc_i_pr$name$0$pvc$data$8$p12$critical$16$b$fork$20$p2$next$28$p2$:
    jmp     wrapper_certlistnet

network.certmsg$f_i_i_vc:
    jmp     wrapper_certmsg

network.certnet$f_fc_i_vc:
    jmp     wrapper_certnet
...
network.openmsgv6$f_x$0$9223372036854775807$i_x$0$9223372036854775807$i_i_i:
    jmp     wrapper_openmsgv6

network.opennet$p_fc_fc_x$0$9223372036854775807$i_i_i:
    jmp     wrapper_opennet

network.opennetv6$p_fc_fc_x$0$9223372036854775807$i_x$0$9223372036854775807$i_i_i:
    jmp     wrapper_opennetv6
...
network.waitnet$p_fc_fc_i_i:
    jmp     wrapper_waitnet

network.wrmsg$p_i_vx$0$255$i:
    jmp     wrapper_wrmsg
