...
void wrapper_deinitlock(int ln)
{
    ami_deinitlock(ln);
}
...
void wrapper_sendsigone(int sn)
{
    ami_sendsigone(sn);
}
...
void wrapper_waitsig(int ln, int sn)
{
    ami_waitsig(ln, sn);
}
